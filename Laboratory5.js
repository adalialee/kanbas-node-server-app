...
const Lab5 = (app) => {
    ...
    app.get("/a5/assignment/name/:newName", (req, res) => {
    ...
    app.get("/a5/assignment/name/completed/:newCompleted", (req, res) => {
        const { newCompleted } = req.params;
        module.completed = newCompleted;
        res.json(module);
    }); 
    app.get("/a5/assignment/name/description/:newDescription", (req, res) => {
        const { newDescription } = req.params;
        module.completed = newDescription;
        res.json(module);
    });  
